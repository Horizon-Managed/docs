...
<Note>
  The full Technology Alignment (TAM/vCIO) workspace — scheduled reviews,
  recommendations, and the client technology roadmap — is planned. Standards
  authoring, CSV/XLSX import, and the built-in baselines are available now.
</Note>
