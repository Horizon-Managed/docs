...
are in-page dialogs styled to match — not the browser's native alert boxes, which
render as an unbranded system pop-up and read as a phishing risk to a cautious
signer.
