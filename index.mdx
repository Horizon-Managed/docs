...
<Card title="Deploy the RMM agent" icon="download" href="/rmm/deploy-agent">
  Roll the NexusRMM agent out to Windows, macOS, and Linux endpoints, and see which features ship per platform.
</Card>
